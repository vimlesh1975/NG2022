...
Public Class ucBreakingNews
            ...
            Using sw As StreamWriter = New StreamWriter(osd2.FileName)
                ...
                Else
                    ...
                    Do Until f = dgvbreakingnews.Rows.Count
                        ...
                        sw.WriteLine(Replace(dgvbreakingnews.Rows(f).Cells(0).Value, Chr(2), " ") & Chr(2) & dgvbreakingnews.Rows(f).Cells(1).Value & Chr(2) & Replace(dgvbreakingnews.Rows(f).Cells(2).Value, Chr(2), " "))
    ...
    Private Sub txtcurrentstory_TextChanged(sender As Object, e As EventArgs)
        On Error Resume Next
        makearray()
    End Sub
    ...
    Private Sub chkusecurrentstory_CheckedChanged(sender As Object, e As EventArgs)
