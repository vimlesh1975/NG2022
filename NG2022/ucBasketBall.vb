Partial Public Class ucBasketBall
    Inherits ucNGBase
    Private Sub NG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmbHeader.Text = "Men's BasketBall"
    ...
    Private Sub cmdeventid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdeventid.Click
        ...
        showtemplate("ng2022/template/BasketBall/event_id", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1lineupball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1lineupball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/teamlineup", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1yball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1yball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/yellow_card", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1rball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1rball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/red_card", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1gball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1gball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/goal", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1inoutball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1inoutball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/in_out", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdteam2inball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdteam2inball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/in", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdteam2outball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdteam2outball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/out", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdvsball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdvsball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/versus", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdopent2ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdopent2ball.Click
        On Error Resume Next
        opendatasg("C: \casparcg\ng2022\data\BasketBall", dgvt2ball, cmbHeader, cmbSubHeader, lblfilenamet2ball)

    End Sub
    Private Sub cmdsavet2ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsavet2ball.Click
        On Error Resume Next
        savedatasg(AppSettings.BasketBallDataPath, dgvt2ball, cmbHeader, cmbSubHeader, lblfilenamet2ball)
    End Sub
    ...
    Private Sub cmdplayeridt1ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdplayeridt1ball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/player_id", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdgoalSummary_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdgoalSummary.Click
        ...
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/Goal_Summary", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdshowsetscoreball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshowsetscoreball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/set7", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdversusboxing_Click(sender As Object, e As EventArgs)
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/versusBoxing", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdscorewithclockboxing_Click(sender As Object, e As EventArgs)
        ...
        CasparCGDataCollection.SetData("ccgloader1", pict1logoball.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader2", pict2logoball.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/score_boxing", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdsetscoreboxing_Click(sender As Object, e As EventArgs)
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/set7Boxing", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdroundscoreboxing_Click(sender As Object, e As EventArgs)
        ...
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/BasketBall/Goal_SummaryBoxing", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdgrouptosemifinalball_Click(sender As Object, e As EventArgs) Handles cmdgrouptosemifinalball.Click
        showtemplate("ng2022/template/BasketBall/grouptosemifinal", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdgroupresultball_Click(sender As Object, e As EventArgs) Handles cmdgroupresultball.Click
        On Error Resume Next
        showtemplate("ng2022/template/BasketBall/groupresult1", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdgroupresul2tball_Click(sender As Object, e As EventArgs) Handles cmdgroupresul2tball.Click
        On Error Resume Next
        showtemplate("ng2022/template/BasketBall/groupresult2", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdmatchstatics_Click(sender As Object, e As EventArgs) Handles cmdmatchstatics.Click
        On Error Resume Next
        showtemplate("ng2022/template/BasketBall/MatchStatics", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdgoalsummarywithtime_Click(sender As Object, e As EventArgs) Handles cmdgoalsummarywithtime.Click
        showtemplate("ng2022/template/BasketBall/goalsummarywithtime", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdpenaltyball_Click(sender As Object, e As EventArgs)
        On Error Resume Next
        CasparCGDataCollection.Clear()
        CasparCGDataCollection.SetData("ccgf0", txtt1ball.Text)
        CasparCGDataCollection.SetData("ccgf1", txtt2ball.Text)
    ...
    Private Sub cmdsavet1ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsavet1ball.Click
        On Error Resume Next
        savedatasg(AppSettings.BasketBallDataPath, dgvt1ball, cmbHeader, cmbSubHeader, lblfilenamet1ball)
    End Sub
    ...
    Private Sub cmdopent1ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdopent1ball.Click
        On Error Resume Next
        opendatasg(AppSettings.BasketBallDataPath, dgvt1ball, cmbHeader, cmbSubHeader, lblfilenamet1ball)
    ...
    Private Sub cmdRaider2_Click(sender As Object, e As EventArgs)
        On Error Resume Next
        Stoptimer30sec.PerformClick()
        CasparCGDataCollection.Clear()
        ...
        CasparDevice.Channels(g_int_ChannelNumber - 1).CG.Update(SafeInt(cmblayergames.Text), SafeInt(cmblayergames.Text), CasparCGDataCollection)
        CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) & " starttimer2()")
    ...
    Private Sub cmd30cueSecondTimer_Click(sender As Object, e As EventArgs)
        ...
        CasparDevice.Channels(g_int_ChannelNumber - 1).CG.Add(SafeInt(cmblayergames.Text) + 2, SafeInt(cmblayergames.Text) + 2, "ng2022/template/BasketBall/30sectimer1", True, CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    Private Sub cmdcue30SecondTimer2_Click(sender As Object, e As EventArgs)
        On Error Resume Next
        CasparCGDataCollection.Clear()
        CasparCGDataCollection.SetData("ccgf0", RaidTime.Text)
        CasparDevice.Channels(g_int_ChannelNumber - 1).CG.Add(SafeInt(cmblayergames.Text) + 2, SafeInt(cmblayergames.Text) + 2, "ng2022/template/BasketBall/30sectimer2", True, CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdSaveas1_Click(sender As Object, e As EventArgs) Handles cmdSaveas1.Click
        On Error Resume Next
        saveasdatasg(AppSettings.BasketBallDataPath, dgvt1ball, cmbHeader, cmbSubHeader, lblfilenamet1ball)
    End Sub

    Private Sub cmdSaveas2_Click(sender As Object, e As EventArgs) Handles cmdSaveas2.Click
        On Error Resume Next
        saveasdatasg(AppSettings.BasketBallDataPath, dgvt2ball, cmbHeader, cmbSubHeader, lblfilenamet1ball)
    End Sub

    Private Sub cmdadd3t2ball_Click(sender As Object, e As EventArgs) Handles cmdadd3t2ball.Click
        On Error Resume Next
        txtt2gball.Text += 3
    ...
    Private Sub cmdadd2t2ball_Click(sender As Object, e As EventArgs) Handles cmdadd2t2ball.Click
        On Error Resume Next
        txtt2gball.Text += 2
    ...
    Private Sub cmdadd3t1ball_Click(sender As Object, e As EventArgs) Handles cmdadd3t1ball.Click
        On Error Resume Next
        txtt1gball.Text += 3
    ...
    Private Sub cmdadd2t1ball_Click(sender As Object, e As EventArgs) Handles cmdadd2t1ball.Click
        On Error Resume Next
        txtt1gball.Text += 2
    ...
    Private Sub cmdResumeShotClock_Click(sender As Object, e As EventArgs) Handles cmdResumeShotClock.Click
        CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) & " starttimer()")
