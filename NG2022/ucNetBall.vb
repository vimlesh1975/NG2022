Public Class ucNetBall
    ...
    Private Sub cmdt1lineupball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1lineupball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/teamlineup", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdt1yball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1yball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/yellow_card", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1rball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1rball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/red_card", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1gball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1gball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/goal", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1inoutball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1inoutball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/in_out", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdteam2inball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdteam2inball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/in", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdteam2outball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdteam2outball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/out", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdvsball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdvsball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/versus", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdplayeridt1ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdplayeridt1ball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/player_id", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdadd1t2ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdadd1t2ball.Click
        ...
        If rdoServiceT1.Checked Then
            rdoServiceT2.Checked = True
        Else
            rdoServiceT1.Checked = True
        End If
    ...
    Private Sub cmdgoalSummary_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdgoalSummary.Click
        ...
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/Goal_Summary", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdshowsetscoreball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshowsetscoreball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/set7", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdversusboxing_Click(sender As Object, e As EventArgs)
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/versusBoxing", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdsetscoreboxing_Click(sender As Object, e As EventArgs)
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/set7Boxing", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdroundscoreboxing_Click(sender As Object, e As EventArgs)
        ...
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/Goal_SummaryBoxing", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdgrouptosemifinalball_Click(sender As Object, e As EventArgs) Handles cmdgrouptosemifinalball.Click
        showtemplate("ng2022/template/netball/grouptosemifinal", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdadd3t2ball_Click(sender As Object, e As EventArgs)
        On Error Resume Next
        txtt2gball.Text += 3
    ...
    Private Sub cmdadd2t2ball_Click(sender As Object, e As EventArgs)
        On Error Resume Next
        txtt2gball.Text += 2
    ...
    Private Sub cmdadd3t1ball_Click(sender As Object, e As EventArgs)
        On Error Resume Next
        txtt1gball.Text += 3
    ...
    Private Sub cmdadd2t1ball_Click(sender As Object, e As EventArgs)
        On Error Resume Next
        txtt1gball.Text += 2
    ...
    Private Sub cmdt2Position_Click(sender As Object, e As EventArgs) Handles cmdt2Position.Click
        On Error Resume Next
        CasparCGDataCollection.Clear()
        For i = 0 To 22
            CasparCGDataCollection.SetData("ccgf" & i, dgvt2ball.Rows(i).Cells(0).Value)
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/netball/PlayerPosition", CasparCGDataCollection.ToAMCPEscapedXml)

    End Sub

    Private Sub cmdt1Position_Click(sender As Object, e As EventArgs) Handles cmdt1Position.Click
        On Error Resume Next
        CasparCGDataCollection.Clear()
        For i = 0 To 22
            CasparCGDataCollection.SetData("ccgf" & i, dgvt1ball.Rows(i).Cells(0).Value)
