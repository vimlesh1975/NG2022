Partial Public Class ucRccBall
    Inherits ucNGBase
    ...
    Private Sub cmdeventid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdeventid.Click
        ...
        showtemplate("ng2022/template/ball/event_id", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdscorewithextraball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdscorewithextraball.Click
        ...
        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "extraalpha('1')" & """")
        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "showClockAndhalf('1')" & """")

        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setTeamcolor('ccgteam1color'," & "'" & ColorTranslator.ToHtml(cmdt1colorball.BackColor) & "')" & """")
        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setTeamcolor('ccgteam2color'," & "'" & ColorTranslator.ToHtml(cmdt2colorball.BackColor) & "')" & """")
    ...
    Private Sub cmdstopscoreball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdstopscoreball.Click
        ...
        On Error Resume Next
        If frmNG2022.chkanimation.Checked Then
            frmNG2022.animation2(SafeInt(cmblayergames.Text) + 1)
        End If
        If frmNG2022.chkanimation.Checked = False Then
            CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " outAnimation()")
        Else
            CasparDevice.Channels(g_int_ChannelNumber - 1).CG.Stop(SafeInt(cmblayergames.Text) + 1, SafeInt(cmblayergames.Text) + 1)
        End If
        ...
        If frmNG2022.chkanimation.Checked Then
            Threading.Thread.Sleep(1000)
            frmNG2022.animationtoscreen(SafeInt(cmblayergames.Text) + 1)
        End If
        tmrtimeupdateontemplate.Enabled = False
    ...
    Private Sub cmdt1lineupball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1lineupball.Click
        ...
        If chkRugy7s.Checked Then
            ...
            For i = 11 To 15
                CasparCGDataCollection.SetData("ccgf" & i, dgvt1ball.Rows(i).Cells(0).Value)
            Next
            CasparCGDataCollection.SetData("ccgf" & 22, dgvt1ball.Rows(22).Cells(0).Value)
            showtemplate("ng2022/template/ball/teamlineupRugby7s", CasparCGDataCollection.ToAMCPEscapedXml)

        Else
            For i = 0 To 22
                CasparCGDataCollection.SetData("ccgf" & i, dgvt1ball.Rows(i).Cells(0).Value)
            Next
            showtemplate("ng2022/template/ball/teamlineup", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt2lineupball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt2lineupball.Click
        ...
        If chkRugy7s.Checked Then
            ...
            For i = 11 To 15
                CasparCGDataCollection.SetData("ccgf" & i, dgvt2ball.Rows(i).Cells(0).Value)
            Next
            CasparCGDataCollection.SetData("ccgf" & 22, dgvt2ball.Rows(22).Cells(0).Value)
            showtemplate("ng2022/template/ball/teamlineupRugby7s", CasparCGDataCollection.ToAMCPEscapedXml)
        Else
            For i = 0 To 22
                CasparCGDataCollection.SetData("ccgf" & i, dgvt1ball.Rows(i).Cells(0).Value)
    ...
    Sub showtemplatescore(ByVal templatename As String, ByVal datacollection As String)
        On Error Resume Next
        If frmNG2022.chkanimation.Checked Then frmNG2022.animation1(SafeInt(cmblayergames.Text) + 1)
        Threading.Thread.Sleep(250)
        CasparDevice.Channels(g_int_ChannelNumber - 1).CG.Add(SafeInt(cmblayergames.Text) + 1, SafeInt(cmblayergames.Text) + 1, templatename, True, datacollection)
        Threading.Thread.Sleep(1300)
        If frmNG2022.chkanimation.Checked Then frmNG2022.animationtoscreen(SafeInt(cmblayergames.Text) + 1)
    End Sub
    ...
    Private Sub cmdt1yball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1yball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/yellow_card", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1rball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1rball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/red_card", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1gball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1gball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/goal", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdt1inoutball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdt1inoutball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/in_out", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdteam2inball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdteam2inball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/in", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdteam2outball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdteam2outball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/out", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdvsball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdvsball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/versus", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    Private Sub cmdsavet1ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsavet1ball.Click
        On Error Resume Next
        savedatasg("C:\casparcg\ng2022\data\ball\", dgvt1ball, cmbHeader, cmbSubHeader, lblfilenamet1ball)
    End Sub
    ...
    Private Sub cmdopent2ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdopent2ball.Click
        On Error Resume Next
        opendatasg("C:\casparcg\ng2022\data\ball\", dgvt2ball, cmbHeader, cmbSubHeader, lblfilenamet2ball)
    ...
    Private Sub cmdplayeridt1ball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdplayeridt1ball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/player_id", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdgoalSummary_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdgoalSummary.Click
        ...
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/Goal_Summary", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdshowsetscoreball_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshowsetscoreball.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/set7", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdscoreboxing_Click(sender As Object, e As EventArgs) Handles cmdscoreboxing.Click
        ...
        CasparCGDataCollection.SetData("showinfo", 1)
        CasparCGDataCollection.SetData("ccgteam1color", ColorTranslator.ToHtml(Color.Red))
        CasparCGDataCollection.SetData("ccgteam2color", ColorTranslator.ToHtml(Color.Blue))

        showtemplatescore("ng2022/template/ball/score", CasparCGDataCollection.ToAMCPEscapedXml)

        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "showinfo('1')" & """")

        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setTeamcolor('ccgteam1color'," & "'" & ColorTranslator.ToHtml(Color.Red) & "')" & """")
        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setTeamcolor('ccgteam2color'," & "'" & ColorTranslator.ToHtml(Color.Blue) & "')" & """")
    ...
    Private Sub cmdversusboxing_Click(sender As Object, e As EventArgs) Handles cmdversusboxing.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/versusBoxing", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdplayeridboxing_Click(sender As Object, e As EventArgs) Handles cmdplayeridboxing.Click
        ...
        If rdoTeamARed.Checked Then
            CasparCGDataCollection.SetData("ccgloader1", pict1logoball.ImageLocation.Replace("\", "/"))
            CasparCGDataCollection.SetData("ccgf0", dgvt1ball.CurrentRow.Cells(0).Value)
            showtemplate("ng2022/template/ball/player_id_red", CasparCGDataCollection.ToAMCPEscapedXml)
        Else
            CasparCGDataCollection.SetData("ccgloader1", pict2logoball.ImageLocation.Replace("\", "/"))
            CasparCGDataCollection.SetData("ccgf0", dgvt2ball.CurrentRow.Cells(0).Value)
            showtemplate("ng2022/template/ball/player_id_blue", CasparCGDataCollection.ToAMCPEscapedXml)
        End If
    ...
    Private Sub cmdwinnerBoxing_Click(sender As Object, e As EventArgs) Handles cmdwinnerBoxing.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/winner", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdsetscoreboxing_Click(sender As Object, e As EventArgs) Handles cmdsetscoreboxing.Click
        ...
        CasparCGDataCollection.SetData("ccgloader5", gamelogo.ImageLocation.Replace("\", "/"))
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/set7Boxing", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdroundscoreboxing_Click(sender As Object, e As EventArgs) Handles cmdroundscoreboxing.Click
        ...
        CasparCGDataCollection.SetData("ccgloader6", eventlogo.ImageLocation.Replace("\", "/"))
        showtemplate("ng2022/template/ball/Goal_SummaryBoxing", CasparCGDataCollection.ToAMCPEscapedXml)
    ...
    Private Sub cmdgrouptosemifinalball_Click(sender As Object, e As EventArgs) Handles cmdgrouptosemifinalball.Click
        showtemplate("ng2022/template/ball/grouptosemifinal", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdgroupresultball_Click(sender As Object, e As EventArgs) Handles cmdgroupresultball.Click
        On Error Resume Next
        showtemplate("ng2022/template/ball/groupresult1", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdgroupresul2tball_Click(sender As Object, e As EventArgs) Handles cmdgroupresul2tball.Click
        On Error Resume Next
        showtemplate("ng2022/template/ball/groupresult2", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdmatchstatics_Click(sender As Object, e As EventArgs) Handles cmdmatchstatics.Click
        On Error Resume Next
        showtemplate("ng2022/template/ball/MatchStatics", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub

    Private Sub cmdgoalsummarywithtime_Click(sender As Object, e As EventArgs) Handles cmdgoalsummarywithtime.Click
        showtemplate("ng2022/template/ball/goalsummarywithtime", CasparCGDataCollection.ToAMCPEscapedXml)
    End Sub
    ...
    Private Sub cmdpenaltyball_Click(sender As Object, e As EventArgs) Handles cmdpenaltyball.Click
            ...
            For iii = 0 To 4
                If .Rows(0).Cells(iii).Value <> "" Then
                    If .Rows(0).Cells(iii).Value = 0 Then
                        ...
                        ' CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setCircleColor('ccgpenaltycircle" & iii + 1 & "'," & "'" & ColorTranslator.ToHtml(Color.Red) & "')" & """")
                    Else
                        CasparCGDataCollection.SetData("ccgpenaltycircle" & iii + 1, ColorTranslator.ToHtml(Color.Green))

                        ' CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setCircleColor('ccgpenaltycircle" & iii + 1 & "'," & "'" & ColorTranslator.ToHtml(Color.Green) & "')" & """")
                    End If
            ...
            For iii = 0 To 4
                If .Rows(1).Cells(iii).Value <> "" Then
                    If .Rows(1).Cells(iii).Value = 0 Then
                        ...
                        ' CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setCircleColor('ccgpenaltycircle" & iii + 1 + 5 & "'," & "'" & ColorTranslator.ToHtml(Color.Red) & "')" & """")
                    Else
                        CasparCGDataCollection.SetData("ccgpenaltycircle" & iii + 1 + 5, ColorTranslator.ToHtml(Color.Green))

                        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "setCircleColor('ccgpenaltycircle" & iii + 1 + 5 & "'," & "'" & ColorTranslator.ToHtml(Color.Green) & "')" & """")
                    End If
        ...
        'CasparDevice.SendString("call " & g_int_ChannelNumber & "-" & SafeInt(cmblayergames.Text) + 1 & " " & """" & "showPenalty('1')" & """")
    ...
    Private Sub cmdSaveas2_Click(sender As Object, e As EventArgs) Handles cmdSaveas2.Click
        On Error Resume Next
        saveasdatasg("C:\casparcg\ng2022\data\ball\", dgvt2ball, cmbHeader, cmbSubHeader, lblfilenamet1ball)
    End Sub

    Private Sub chkRugy7s_CheckedChanged(sender As Object, e As EventArgs) Handles chkRugy7s.CheckedChanged
        If chkRugy7s.Checked Then
            txtminball.Text = "7"
        Else
            txtminball.Text = "45"
